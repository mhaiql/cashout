...
public class TransactionProduct10Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_transaction_product10);
        ...
        btnPay = (Button) findViewById(R.id.btn_pay10);
